package edu.ntnu.idatt2105.funn.mapper.location;
...
public interface LocationMapper {
  LocationMapper INSTANCE = org.mapstruct.factory.Mappers.getMapper(LocationMapper.class);
  ...
  PostCode locationResponseDTOToPostCode(LocationResponseDTO locationResponseDTO);
  ...
  @Mappings(
    {
      @Mapping(target = "postCode", source = "postCode", qualifiedByName = "getPostCode"),
      @Mapping(target = "city", source = "postCode", qualifiedByName = "getCity"),
    }
  )
   ...
   */
  @Mappings(
    { @Mapping(target = "postCode", ignore = true), @Mapping(target = "listings", ignore = true) }
  )
  Location locationResponseDTOToLocation(LocationResponseDTO locationResponseDTO);
