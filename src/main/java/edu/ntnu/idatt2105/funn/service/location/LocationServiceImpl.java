...
public class LocationServiceImpl implements LocationService {
  ...
  public Location getLocationById(Long id) throws LocationDoesntExistException, DatabaseException {
    try {
      return locationRepository.findById(id).orElseThrow(() -> new LocationDoesntExistException());
    } catch (Exception e) {
      if (e instanceof LocationDoesntExistException) throw e; else throw new DatabaseException(
  ...
  public void deleteLocation(Long id) throws LocationDoesntExistException, DatabaseException {
    if (!locationRepository.existsById(id)) throw new LocationDoesntExistException();
   ...
   */
  @Override
  public List<Location> getLocationsInDistance(double longitude, double latitude, double distance)
    ...
    try {
      return locationRepository
        .findByLatitudeAndLongitudeByRadius(minLatitude, maxLatitude, minLongitude, maxLongitude)
        .filter(l -> !l.isEmpty())
        .orElseThrow(() -> new LocationDoesntExistException());
    } catch (Exception e) {
      if (e instanceof LocationDoesntExistException) throw e; else throw new DatabaseException(
