package edu.ntnu.idatt2105.placeholder.mapper.file;
...
/**
 * Class used to map between Image and ImageDTO.
 * @author Callum G.
...
public abstract class ImageMapper {
  ...
  public static ImageMapper INSTANCE = Mappers.getMapper(ImageMapper.class);

  @Autowired
  private ImageService locationService;
