...
public interface ListingRepository extends JpaRepository<Listing, Long> {
  ...
  List<Listing> findByUserAndKeyWord(User user, String keyWord, Sort sort);

  @Query("SELECT l FROM Listing l WHERE l.user = ?1 AND l.category = ?2")
  List<Listing> findByUserAndCategory(User user, String category, Sort sort);
  ...
  List<Listing> findByUserAndCategoryAndKeyWord(
    User user,
    String category,
    String keyWord,
    Sort sort
  ...
  List<Listing> findByCategoryAndKeywordAndLocation(
    String category,
    String keyword,
    Double minLatitude,
    Double maxLatitude,
  ...
  List<Listing> findByKeywordAndLocation(
    String keyword,
    Double minLatitude,
    Double maxLatitude,
    Double minLongitude,
  ...
  List<Listing> findByCategoryAndLocation(
    String category,
    Double minLatitude,
    Double maxLatitude,
    Double minLongitude,
