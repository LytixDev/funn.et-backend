...
import edu.ntnu.idatt2105.placeholder.controller.location.LocationController;
...
import edu.ntnu.idatt2105.placeholder.security.SecurityConfig;
...
public class LocationControllerTest {
  ...
  public void testGetLocationExists()
    ...
    when(postCodeService.savePostCode(location.getPostCode()))
      .thenReturn(location.getPostCode());
  ...
  public void testGetLocationNonExistent()
    ...
    when(locationService.getLocationById(1l))
      .thenThrow(new LocationDoesntExistException());
