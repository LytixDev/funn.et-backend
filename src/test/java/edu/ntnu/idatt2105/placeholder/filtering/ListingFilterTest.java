...
public class ListingFilterTest {
  ...
  public void testListingFilterSpecificationEqual() {
    ...
    assertEquals(
      found.getContent().get(0).getBriefDescription(),
      listing1.getBriefDescription()
    );
    assertEquals(
      found.getContent().get(0).getFullDescription(),
      listing1.getFullDescription()
    );
    assertEquals(found.getContent().get(0).getPrice(), listing1.getPrice());
    assertEquals(
      found.getContent().get(0).getCategory(),
      listing1.getCategory()
    );
  }
  ...
  public void testListingFilterSpecificationIn() {
    FilterRequest filterRequest = FilterRequest
      .builder()
      .values(
        List.of(listing1.getTitle(), listing2.getTitle(), listing3.getTitle())
      )
      .fieldType(FieldType.STRING)
      .keyWord("title")
